...
'description': 'Dolce Shine by Dolce & Gabbana is a vibrant and fruity fragrance, featuring notes of mango, jasmine, and blonde woods. its a joyful and youthful scent.',
'category': 'fragrances',
'price': 69.99,
...
'description': 'Gucci Bloom by Gucci is a floral and captivating fragrance, with notes of tuberose, jasmine, and Rangoon creeper. its a modern and romantic scent.',
'category': 'fragrances',
'price': 79.99,
...
#print(len(product_data['products']))
bt_products=[]
gr_products=[]
fr_products=[]
f_products=[]
for product in product_data['products']:
    if product['category']=='beauty':
        bt_products.append(product)
print(bt_products)
print(len(bt_products))
for product in product_data['products']:
    if product['category']=='groceries':
        gr_products.append(product)
print(gr_products)
print(len(gr_products))
for product in product_data['products']:
    if product['category']=='fragrances':
        fr_products.append(product)
print(fr_products)
print(len(bt_products))
for product in product_data['products']:
